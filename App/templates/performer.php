		...
		<div class="row">
			<div class="col-md-3">
				<div class="panel panel-default preview">
					<img src="/App/templates/img/performers/<?= $performer->image ?>" alt="" class="img-responsive">
				</div>
			</div>
			<div class="col-md-9">
				<h2>Исполнитель: <?= $performer->name ?></h2>
				<form  class="form-horizontal" role="form" method="POST" action="<?= $_SERVER[REQUEST_URI]; ?>" id="editPerformer" enctype="multipart/form-data">

					<div class="clearfix">
						<div class="control-group pull-left">
							<label class="control-label" for="name">имя:</label>
							<input type="text" id="name" name="name" class="form-control" value="<?= $performer->name ?>">
						</div>
					...
					<div class="control-group">
						...
						<input type="text" id="phone" name="phone" class="form-control"  value="<?= $performer->phone ?>">
					</div>
					<div class="control-group">
						<label class="control-label" for="address">адрес:</label>
						<input type="text" id="address" name="address" class="form-control"  value="<?= $performer->address ?>">
					</div>
					<div class="control-group">
						<label class="control-label" for="description">примечание:</label>
						<textarea class="form-control" rows="3" id="description" name="description"><?= $performer->description ?></textarea>
					</div>
					<div class="checkbox">
							<label>
